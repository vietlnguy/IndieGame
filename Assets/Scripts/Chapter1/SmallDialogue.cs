...
public class SmallDialogue : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        dialogues = new CharacterDialogue[] {
            //SmallDialogue
            new CharacterDialogue(false, false, mainCharacterSprite, scm.loadedData.mainCharacterName, new string[] {"Honey, I'm back!"}),
            new CharacterDialogue(false, false, astridSprite, "Astrid", new string[] {"Oh! Back so soon?", "I've hardly started dinner!"}),
            new CharacterDialogue(false, false, mainCharacterSprite, scm.loadedData.mainCharacterName, new string[] {"I had an early start this morning.", "Need an extra hand?"}),
            ...
            new CharacterDialogue(false, false, mainCharacterSprite, scm.loadedData.mainCharacterName, new string[] {"It's hard to relax when there is still so much to do...", "I'm the one that said we should move out here.", "I'm starting to wonder if that was a dumb decision..."}),
            ...
            new CharacterDialogue(false, false, mainCharacterSprite, scm.loadedData.mainCharacterName, new string[] {"I don't deserve you."}),
            ...
            new CharacterDialogue(false, true, mainCharacterSprite, scm.loadedData.mainCharacterName, new string[] {"Actually, I don't feel as sore as-- uughh--"}),
            ...
            new CharacterDialogue(false, false, mainCharacterSprite, scm.loadedData.mainCharacterName, new string[] {"Haah... maybe you're right.. Ahh...", "It doesn't help that you're draining all of the blood from my head now, too."}),
            ...
            new CharacterDialogue(false, false, mainCharacterSprite, scm.loadedData.mainCharacterName, new string[] {"Ungh..."}),
            new CharacterDialogue(false, false, astridSprite, "Astrid", new string[] {"Mwgh, mwgh, mwgh..."}),
            new CharacterDialogue(false, false, mainCharacterSprite, scm.loadedData.mainCharacterName, new string[] {"Ahh-- it feels too good!", "I don't think I can hold it in any longer!"}),
            ...
            new CharacterDialogue(false, false, mainCharacterSprite, scm.loadedData.mainCharacterName, new string[] {"It's been a while since we've been in battle.", "Let's take this slowly.", "I'll charge the enemy, you support me from behind."}),
